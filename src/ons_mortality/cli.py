...
from ons_mortality.ons import discover_ons_files, iter_downloaded_files, register_source_file
...
def handle_ingest(args: argparse.Namespace) -> None:
    ...
    for file, local_path in iter_downloaded_files(files, output_dir=paths.raw_dir, overwrite=args.overwrite):
